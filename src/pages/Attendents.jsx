...
const Attendance = () => {
  ...
  const checkActiveSession = (attendanceData) => {
    ...
    const userRecords = attendanceData.filter(
      (record) => record.salesPersonName === salesPersonName
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        const successMessage = formData.status === "IN" ? "Check-in successful!" : 
                              formData.status === "OUT" ? "Check-out successful!" : 
        ...
        if (response.ok) {
          try {
            ...
            console.log("Response parsing issue, but success message already shown");
          }
        }
            ...
            <div className="grid gap-6 lg:grid-cols-1">
              <div className="space-y-2">
                ...
                >
                  ...
                  >
                    IN {hasActiveSession ? '(Already checked in)' : ''}
                  </option>
