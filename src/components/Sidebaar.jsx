...
//   Plane,
//   Video,
//   Shield, // Add this import for License
// } from "lucide-react";
...
function Sidebar({ userType, username, tabs = [] }) {
  ...
  console.log("Tabs prop received:", tabs);
  console.log("Tabs length:", tabs ? tabs.length : 0);
  console.log("Available routes labels:", availableRoutes.map(r => r.label));
  ...
  const filteredRoutes = !tabs || tabs.length === 0
    ...
    : availableRoutes.filter((route) => {
        ...
        console.log(`Route ${route.label} included:`, isIncluded);
        return isIncluded;
      });

  console.log("Filtered routes:", filteredRoutes.map(r => r.label));
